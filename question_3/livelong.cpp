...
void make2()
{
    ...
    //taking the input from the file with the names and all that
    for(i=1;i<=30;i++)
    {
    ...
    //time to be a nice bpyfriend by giving gifts to ur girlfriend according to all that needs
    for(i=1;i<=30;i++)
    {
